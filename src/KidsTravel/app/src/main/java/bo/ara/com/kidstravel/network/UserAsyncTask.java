...
public class UserAsyncTask extends AsyncTask<Void, Void, User> {
    ...
    protected void onPostExecute(User user) {
        ...
        if (user == null) {
            // Fail
            Toast.makeText(userActivity, "Create user fail", Toast.LENGTH_LONG).show();
        }
        else {
            ...
            if(user.getUsername().equals(""))
                ...
                Toast.makeText(userActivity, "Create user successful, userId: " + user.get_id() + ", userImage: " + user.getImageUrl(), Toast.LENGTH_LONG).show();
