...
public class TravelAdapter extends ArrayAdapter<Travel> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(travel.getStatus().equals("Requested"))
            statusImage.setImageResource(R.drawable.ticket_requested_small);
        else if(travel.getStatus().equals("Authorized"))
            statusImage.setImageResource(R.drawable.ticket_authorized_small);
        else if(travel.getStatus().equals("Approved"))
            statusImage.setImageResource(R.drawable.ticket_approved_small);
        else if(travel.getStatus().equals("Rejected"))
            statusImage.setImageResource(R.drawable.ticket_rejected_small);
        //>>
